...
abstract class FittiDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_8_9 = object : Migration(8, 9) {
            override fun migrate(db: SupportSQLiteDatabase) {
                val heavy = ExerciseEntity.NAUTILUS_HEAVY_STACK_KG
                db.execSQL("UPDATE exercises SET weightSteps = '$heavy' WHERE code = 'B6' AND (weightSteps = '' OR weightSteps IS NULL)")
            }
        }
