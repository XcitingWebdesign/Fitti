...
data class ExerciseEntity(
    ...
    companion object {
        /** Nautilus Inspiration standard weight stack (kg, full range) */
        const val NAUTILUS_WEIGHT_STACK_KG = "9,14,18,23,27,32,36,41,46,50,55,59,64,68,73,77,82,86,91,96,100,105,109"
        /** Nautilus Inspiration short weight stack (kg, e.g. Ab Crunch) */
        const val NAUTILUS_WEIGHT_STACK_KG_SHORT = "9,14,18,23,27,32,36,41,46,50,55,59,64,68,73,77,82,86,91"
